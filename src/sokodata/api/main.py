...
from sokodata.api.routers import agriculture, catalog, climate, commodities, demographics, economy, education, energy, health as health_router, insights, markets, mining, prices, transport, water, webhooks
