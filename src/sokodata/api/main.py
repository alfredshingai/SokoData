...
from sokodata.api.routers import agriculture, catalog, climate, commodities, demographics, economy, health as health_router, insights, markets, prices, webhooks
